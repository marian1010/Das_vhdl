...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {clickaux}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {clickaux}]
set_property PACKAGE_PIN E19 [get_ports {new_data}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {new_data}]
...
set_property PACKAGE_PIN U2 [get_ports {display[8]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {display[8]}]
set_property PACKAGE_PIN U4 [get_ports {display[9]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {display[9]}]
set_property PACKAGE_PIN V4 [get_ports {display[10]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {display[10]}]
set_property PACKAGE_PIN W4 [get_ports {display[11]}]                                        
